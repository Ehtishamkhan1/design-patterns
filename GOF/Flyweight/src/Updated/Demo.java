...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Math.floor(TREES_TO_DRAW / TREE_TYPES); i++) {
            ...
            // Set isFruitTree and countOfFruits based on your criteria
            boolean isFruitTree = (Math.random() < 0.5);  // Example: 50% chance of being a fruit tree
            int countOfFruits = isFruitTree ? random(1, 10) : 0;  // Example: If it's a fruit tree, set a random count; otherwise, 0

            // Corrected method call with six parameters
